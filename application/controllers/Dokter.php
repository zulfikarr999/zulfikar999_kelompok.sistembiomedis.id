...
class Dokter extends CI_Controller
{
    ...
    function cetak()
    {
        ...
        $pdf->Cell(40, 7, '', 0, 0, 'C');
        $pdf->Cell(275, 7, 'Jl. Pemuda No.61 59511.', 0, 1, 'C');
        $pdf->Cell(80, 7, '', 0, 0, 'C');
        $pdf->Cell(190, 7, 'Telepon : (0267) 4218872. E-mail: HealthCenter@gmail.com', 0, 1, 'C');
    ...
    function cetakrujukan()
    {
        ...
        //$pdf->Image('', a)
        // mencetak string 
        $pdf->Cell(190, 7, 'HealthCenter', 0, 1, 'C');
        $pdf->SetFont('Arial', '', 12);
        $pdf->Cell(190, 7, 'Jl. Pemuda No.61 59511.', 0, 1, 'C');
        $pdf->Cell(190, 7, 'Telepon : (0267) 4218872. E-mail: HealthCenter@gmail.com', 0, 1, 'C');
