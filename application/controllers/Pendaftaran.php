...
class Pendaftaran extends CI_Controller
{
    ...
    function cetak()
    {
        ...
        // mencetak string 
        $pdf->Cell(45, 7, '', 0, 0, 'C');
        $pdf->Cell(290, 7, 'HealthCenter', 0, 1, 'C');
        $pdf->SetFont('Arial', '', 12);
        $pdf->Cell(30, 7, '', 0, 0, 'C');
        $pdf->Cell(330, 7, 'Jl. Pemuda No.61 59511.', 0, 1, 'C');
        $pdf->Cell(70, 7, '', 0, 0, 'C');
        $pdf->Cell(250, 7, 'Telepon : (0267) 4218872. E-mail: HealthCenter@gmail.com', 0, 1, 'C');
    ...
    function cetakbulan()
    {
        ...
        // mencetak string 
        $pdf->Cell(45, 7, '', 0, 0, 'C');
        $pdf->Cell(290, 7, 'PUSKESMAS DEMAk', 0, 1, 'C');
        $pdf->SetFont('Arial', '', 12);
        $pdf->Cell(30, 7, '', 0, 0, 'C');
        $pdf->Cell(330, 7, 'Jl. Pemuda No.61 59511.', 0, 1, 'C');
        $pdf->Cell(70, 7, '', 0, 0, 'C');
        $pdf->Cell(250, 7, 'Telepon : (0267) 4218872. E-mail: puskesdemak@gmail.com', 0, 1, 'C');
        $pdf->Line(10, 35, 440 - 20, 35);
        $pdf->Line(10, 35.5, 440 - 20, 35.5);
