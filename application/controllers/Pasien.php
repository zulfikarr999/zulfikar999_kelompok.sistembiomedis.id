...
class Pasien extends CI_Controller
{
    ...
    function cetak()
    {
        ...
        // mencetak string 
        $pdf->Cell(45, 7, '', 0, 0, 'C');
        $pdf->Cell(260, 7, 'HealthCenter', 0, 1, 'C');
        $pdf->SetFont('Arial', '', 12);
        $pdf->Cell(30, 7, '', 0, 0, 'C');
        $pdf->Cell(300, 7, 'Jl. Pemuda No.61 59511.', 0, 1, 'C');
        $pdf->Cell(70, 7, '', 0, 0, 'C');
        $pdf->Cell(220, 7, 'Telepon : (0267) 4218872. E-mail: HealthCenter@gmail.com', 0, 1, 'C');
    ...
    function cetakkartu($id)
    {
        ...
        $pdf->Cell(90, 5, 'PUSKESMAS DEMAK', 0, 0, 'C');
        $pdf->Cell(10, 5, '', 0, 0, 'C');
        $pdf->setFont('Arial', 'B', 10);
        $pdf->Cell(90, 5, 'KETENTUAN', 0, 1, 'C');
        $pdf->setFont('Arial', 'B', 8);
        $pdf->Cell(90, 5, 'Jl. Pemuda No.61 59511.', 0, 0, 'C');
        $pdf->Cell(10, 5, '', 0, 0, 'C');
        $pdf->setFont('Arial', '', 7);
        $pdf->Cell(90, 5, '- Kartu ini hanya bisa digunakan untuk berobat di puskesmas demak.', 0, 1, 'L');
